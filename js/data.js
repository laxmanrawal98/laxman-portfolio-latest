...
window.LR_DATA = {
  ...
  projects: [
    ...
    },
    {
      ...
      solutions: [
        "AI-Powered Unified Dashboard & LinkedIn Lookalike Prospecting Engine\nBuilt a centralized Real Estate CRM and Lead Intelligence Dashboard.\nIntegrated directly with property portals, ad campaigns, and the [Apify] LinkedIn API. The system analyzes existing high-ticket buyers' professional profiles, wealth indicators, and company roles to automatically discover, scrape, and score lookalike NRI and HNWI leads in real time.",
      ...
      impacts: [
        ...
        "40% Reduction in Cost Per Acquisition (CPA): Automated lookalike lead discovery via [Apify] LinkedIn API improved target lead quality, drastically reducing wasted ad spend.",
  ...
  skills: [
    {
      ...
      items: [
        ...
        "Leadership & Stakeholder Management: Team Mentorship, Cross-Functional Alignment, Client Management, Acting Team Management.",
      ],
    },
    {
      title: "Tech Stack",
  ...
  techBubbles: [
    ...
    { name: "Gemini Notebook", icon: "assets/logos/notebooklm.svg" },
